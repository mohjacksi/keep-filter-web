...
@section('title') منتجات قسم السياره - "{{$carCategory->name}}" @endsection
@section('content')
...
<div class="card card-custom gutter-b">
    <div class="card-header">
        <div class="card-title">
            <h3 class="card-label">المنتجات التابعه للقسم - {{$carCategory->name}}</h3>
        </div>
    </div>
    <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered mb-6">
                    <tbody>
                        ...
                        @forelse ($carCategory->Products as  $product)
                        <tr>
                            <td>{{$product->id}}</td>
                            <td>{{$product->title}}</td>
